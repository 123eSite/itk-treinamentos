...
<section class="hero-style8">
    ...
    <div class="parallax-wrap">
        <img src="<?php echo esc_url( $imagem_banner['sizes']['itk-hero'] ); ?>"
             alt="<?php echo esc_attr( $imagem_banner['alt'] ); ?>"
             class="parallax-img">
    </div>
    <?php endif; ?>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="hero-content8 text-center">
                    ...
                    <img width="200"
                         src="<?php echo esc_url( $logo_principal['url'] ); ?>"
                         alt="<?php echo esc_attr( $logo_principal['alt'] ); ?>"
                         class="logo-leader-training">
                    <?php endif; ?>
                    <h2 class="title"><?php echo esc_html( $titulo ); ?></h2>
                    <?php if ( $texto ) : ?>
                    <p><?php echo nl2br( esc_html( $texto ) ); ?></p>
                    <?php endif; ?>
                    <?php if ( $botao_texto ) : ?>
